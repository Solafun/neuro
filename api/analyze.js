...

{
  ...
  "cognitive_profile": {
    ...
    "biases": ["КОГНИТИВНЫЕ ИСКАЖЕНИЯ. 3-4 ошибки из классического списка с нормальным обоснованием! Формат СТРОГО: «<Название на русском>: <как именно это проявляется у этого человека>». Пример: «Эффект якоря: судит людей по первому впечатлению и не меняет мнение»"],
