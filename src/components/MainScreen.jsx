    ...
    return (
        <>
            <motion.div
                ...
                className="hero-container flex-1 flex flex-col items-center justify-start pt-10 w-full relative"
            >
                ...
                <div className="w-full max-w-sm px-6 flex flex-col gap-4">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <div className="status-badge w-full py-4">
            ...
            <div className="fixed bottom-8 left-0 right-0 px-4 text-[12px] text-[var(--text-muted)] font-black uppercase tracking-[0.2em] opacity-80 flex items-center justify-center gap-2 text-center pointer-events-none z-50">
