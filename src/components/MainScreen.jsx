...
export default function MainScreen({ nickname, setNickname, onAnalyze, userChecks, analysisMode, setAnalysisMode }) {
    ...
    useEffect(() => {
        const handleResize = () => {
            // Keyboard detection: height significantly smaller than viewport
    ...
    return (
        ...
        >
            ...
            {!isKeyboardVisible && (
                <div className="mt-auto mb-6 text-[12px] text-[var(--text-muted)] font-black uppercase tracking-[0.2em] opacity-80 flex items-center justify-center w-full gap-2 text-center transition-opacity duration-300">
                    {t('creator')}{" "}
