...
export default function MainScreen({ nickname, setNickname, onAnalyze, userChecks, analysisMode, setAnalysisMode }) {
    ...
    return (
        ...
        >
            ...
            <div className="mt-10 mb-6 text-[12px] text-[var(--text-muted)] font-black uppercase tracking-[0.2em] opacity-80 flex items-center justify-center w-full gap-2 text-center">
                {t('creator')}{" "}
